...
#define HNEXT_OFFSET_ESCALATION                    HNEXT_OFFSET_ESCALATION_POLICY_2
#define HNEXT_OFFSET_ESCALATION_POLICY_1           1
#define HNEXT_OFFSET_ESCALATION_POLICY_2           2

/* Offset-based packet selection policy */
#define HNEXT_PACKET_SELECTION                     1

/* Backoff policy for postponed packets */
#define HNEXT_TEMP_BCAST_BACKOFF                   1 /* HNEXT TODO: Need to distinguish EB/broadcast nbrs */
#define HNEXT_TSCH_MAC_BCAST_MAX_BE                5
#define HNEXT_TEMP_RANDOM_RX                       0
#define HNEXT_POSTPONED_BACKOFF_POLICY             HNEXT_POSTPONED_BACKOFF_POLICY_3 /* 0 or 3 */
