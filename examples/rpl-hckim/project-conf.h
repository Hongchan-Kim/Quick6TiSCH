...
#define HNEXT_OFFSET_ASSIGNMENT_POLICY             HNEXT_OFFSET_ASSIGNMENT_POLICY_2
#define HNEXT_OFFSET_ASSIGNMENT_POLICY_0           0 /* Baseline */
#define HNEXT_OFFSET_ASSIGNMENT_POLICY_1           1 /* Random */
#define HNEXT_OFFSET_ASSIGNMENT_POLICY_2           2 /* BC / UC / BC / UC */
#define HNEXT_OFFSET_ASSIGNMENT_POLICY_3           3 /* BC / UC / UC / BC */

/* Offset escalation policy for postponed packets */
#define HNEXT_OFFSET_ESCALATION                    1 /* HNEXT TODO */
...
#define HNEXT_POSTPONED_BACKOFF_POLICY             HNEXT_POSTPONED_BACKOFF_POLICY_4
