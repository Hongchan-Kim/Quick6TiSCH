...
#elif WITH_QUICK6
  LOG_HCK("eval_config 3 scheme 3 | Quick6TiSCH %u %u %u %u %u %u %u %u %u %u\n",
          QUICK6_OFFSET_POSTPONEMENT_BASED_PRIORITIZATION,
          QUICK6_OFFSET_POSTPONEMENT_THRESH,
          QUICK6_OFFSET_POSTPONEMENT_SCALING_FACTOR,
          QUICK6_OFFSET_CRITICALITY_BASED_PRIORITIZATION,
          QUICK6_OFFSET_EB_DIO_CRITICAL_THRESH,
