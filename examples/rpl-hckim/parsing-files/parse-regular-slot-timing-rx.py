    ...
    if len(line) > 1:
        ...
        if len(line_s) > 1:
            ...
            if message[0] == '{asn':
                ...
                if contents[0] == 'reg' and contents[1] == 'r_r':
                    if contents[3] == '1':
                        ...
                        if current_len >= minimum_len:
                            ...
                            if regular_slot_timing_updated[current_len_index] == 0:
                                ...
                                if len(line_t) > 1:
                                    ...
                                    regular_slot_timing[current_len_index][6] = contents_t[6]
                                line_t = f.readline()
                                if len(line_t) > 1:
                                    line_t = line_t.replace('\n', '') 
                                    message_t_s = line_t.split('} ')
                                    contents_t = message_t_s[1].split(' ')
                                    regular_slot_timing[current_len_index][7] = contents_t[2]
                                    regular_slot_timing[current_len_index][8] = contents_t[3]
                                    regular_slot_timing[current_len_index][9] = contents_t[4]
                                    regular_slot_timing[current_len_index][10] = contents_t[5]
                                    regular_slot_timing[current_len_index][11] = contents_t[6]
                                line_t = f.readline()
                                if len(line_t) > 1:
                                    line_t = line_t.replace('\n', '') 
                                    message_t_s = line_t.split('} ')
                                    contents_t = message_t_s[1].split(' ')
                                    regular_slot_timing[current_len_index][12] = contents_t[2]
                                    regular_slot_timing[current_len_index][13] = contents_t[3]
                                    regular_slot_timing[current_len_index][14] = contents_t[4]
                                    regular_slot_timing[current_len_index][15] = contents_t[5]
    line = f.readline()
f.close()
